    ...
    <div className="container">
      ...
      <header className="animate-fade-up">
        ...
        <div className="avatar-wrapper">
          <img src="/logoicon.png" alt="Моё фото" className="avatar" />

          {/* Иконки, вылетающие из аватара */}
          <div className="avatar-orbit">
            <a 
              href="https://github.com/igorzolo" 
              target="_blank" 
              rel="noopener noreferrer"
              className="orbit-icon icon-github" 
              aria-label="GitHub"
            >
            ...
            <div className="orbit-icon icon-js" aria-label="JavaScript">
              <span>JS</span>
            </div>

            <div className="orbit-icon icon-react" aria-label="React">
              <svg viewBox="0 0 24 24" width="22" height="22" fill="currentColor">
            ...
            <div className="orbit-icon icon-html" aria-label="HTML5">
              <span>HTML</span>
            </div>
          </div>
        </div>
